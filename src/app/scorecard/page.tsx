    ...
    <div>
      ...
      <Modal open={showCreate} onClose={() => setShowCreate(false)} title="Add Scorecard Metric">
        <form onSubmit={(e) => { e.preventDefault(); handleCreate(); }} className="space-y-4">
          ...
          <div>
            <label htmlFor="metric-description" className="block text-sm font-medium text-gray-700 mb-1">Description</label>
            <input id="metric-description" className="input" value={form.description} onChange={e => setForm(f => ({ ...f, description: e.target.value }))} />
          </div>
