    ...
    <div>
      ...
      <Modal open={showCreate} onClose={() => setShowCreate(false)} title="Create Team">
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleCreate(); }}>
          <div>
            <label htmlFor="teamName" className="block text-sm font-medium text-gray-700 mb-1">Team Name <span className="text-red-500" aria-hidden="true">*</span></label>
          ...
          <div>
            <label htmlFor="companyId" className="block text-sm font-medium text-gray-700 mb-1">Company <span className="text-red-500" aria-hidden="true">*</span></label>
